...
from app.db import models  # Import your models module to ensure models are registered
...
def run_migrations_online() -> None:
    ...
    """
    connectable = create_engine(database_url)  # Use the database_url from env
